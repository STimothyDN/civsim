...
import { PARTIES, formatShare, lowerHouseName, upperHouseName, lowerHouseLeaderTitle, upperHouseLeaderTitle } from '../domain/elections'
...
export default {
  ...
  setup() {
    ...
    const {
      ...
      seatDetails: overviewAssemblySeatDetails,
      store,
      electionStore,
      seatIndexOffset: 0,
    ...
    const {
      ...
      seatDetails: overviewCouncilSeatDetails,
      store,
      electionStore,
      seatIndexOffset: 2500,
